            ...
            <div class="row">
                ...
                <select name="id_barang" class="form-control" id="id_barang">
                    ...
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($product->id_barang); ?>" data-harga="<?php echo e($product->harga_beli); ?>">
                            <?php echo e($product->nama_barang); ?>
...
<?php echo $__env->make('dashboard.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SIAKUNTANSI\resources\views/dashboard/invoice/create.blade.php ENDPATH**/ ?>